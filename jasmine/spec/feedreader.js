...
$(function() {
    ...
    */
    ...
    describe('The menu', function() {
         ...
         * use code from HTML and CSS file to analyze
    ...
    describe('New Feed Selection', function() {
         ...
         * loadFeed() is asynchronous so we use Jasmine's beforeEach and
        ...
        beforeEach(function(done) {
            loadFeed(0, function() {
                ...
                // Show the content at index 2
                loadFeed(2, () => done());
            });
        });
        // Compare original feed and updated feed, they should be difference
        it('should change the content when a new feed is loaded', function() {
            expect(container.html()).not.toEqual(initialFeed);
        });
    });
}());
